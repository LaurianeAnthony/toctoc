...
export default function InstanceScreen() {
  ...
  const checklistInstance: ChecklistInstance = {
      ...
      items: [
        { id: '1', title: 'Prendre les clés', completedAt: '2023-10-01T10:00:00Z' },
        { id: '2', title: 'Prendre le sac', completedAt: '2023-10-01T10:05:00Z' },
        { id: '3', title: 'Vérifier le téléphone', completedAt: null },
        { id: '4', title: 'Fermer la porte', completedAt: '2023-10-01T10:10:00Z' },
      ],
    };
  ...
  return (
    <Screen>
      <Header title={checklistInstance.title} icon="chevron-left" onPress={() => router.back()} />
